...
Public Class RDetalleSolicitud2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GrupoAcosta.RDetalleSolicitud2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRDetalleSolicitud2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RDetalleSolicitud2 = New RDetalleSolicitud2()
        rpt.Site = Me.Site
        Return rpt
    End Function
