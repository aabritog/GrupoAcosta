...
Public Class RDetalleSolicitud
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GrupoAcosta.RDetalleSolicitud.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRDetalleSolicitud
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RDetalleSolicitud = New RDetalleSolicitud()
        rpt.Site = Me.Site
        Return rpt
    End Function
