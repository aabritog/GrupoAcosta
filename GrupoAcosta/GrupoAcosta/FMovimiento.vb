Public Class FMovimiento
    ...
    Private Sub mostrarDGVMovimiento()
        ...
        Using conexion As New Odbc.OdbcConnection(My.Settings.ConnectionString)
            ...
            bsDGVMovimientoFilter = bsDGVMovimiento
    ...
    Private Sub BTNEliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNEliminar.Click
        ...
        If MsgBox("¿Esta seguro de querer eliminar a este movimiento?. No se podran recuperar los datos", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
            Dim SQLEliminarMovimiento As String = ""
            SQLEliminarMovimiento = "DELETE FROM movimiento WHERE nid=" & DGVMovimiento.CurrentRow.Cells("nid").Value & ""
            objCGenerica.accederBD(SQLEliminarMovimiento)
            mostrarDGVMovimiento()
            BTNCancelar_Click(sender, e)
    ...
    Private Sub FMovimiento_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        mostrarDGVMovimiento()
        DGVMovimiento.ClearSelection()
    End Sub
