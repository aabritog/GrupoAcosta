...
Public Class FRol
    ...
    Dim bsDGVRolFilter As New BindingSource

    Public nAction As Integer

    Private Sub mostrarDGVRol()

        Dim sCadenaSQL As String = "select d.nid, d.s_descripcion, d.s_descripcioncorta from rol d where d.s_activo = '1' order by s_descripcion"

        Using conexion As New Odbc.OdbcConnection(My.Settings.ConnectionString)

            Dim dtDGVRol As New DataTable
            Dim bsDGVRol As New BindingSource

            objCGenerica.cargarComboBoxDataGridView(sCadenaSQL, dtDGVRol, bsDGVRol)
            bsDGVRolFilter = bsDGVRol
    ...
    Private Sub BTNGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNGuardar.Click
        ...
        If nAction = 1 Then
            ...
            SQLGuardar = "insert into rol (s_descripcion, s_descripcioncorta, d_fecha, s_activo) values ('" & TXTDescripcion.Text & "', '" & TXTDescripcionCorta.Text & "', '" & Date.Today.ToString("yyyy-MM-dd") & "', '1')"
            ...
            MsgBox("Se ha agregado el rol exitosamente.", MsgBoxStyle.Information)
        ...
        ElseIf nAction = 2 Then
            ...
            SQLActualizar = "UPDATE rol SET s_descripcion='" & TXTDescripcion.Text & "',s_descripcioncorta='" & TXTDescripcionCorta.Text & "', d_fecha= '" & Date.Today.ToString("yyyy-MM-dd") & "' WHERE nid=" & DGVRol.CurrentRow.Cells("nid").Value & ""
    ...
    Private Sub BTNModificar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNModificar.Click
        ...
        TXTDescripcion.Text = Trim(DGVRol.CurrentRow.Cells("s_descripcion").Value)
        'TXTClave.Text = Trim(DGVUsuario.CurrentRow.Cells("s_clave").Value)
        TXTDescripcionCorta.Text = Trim(DGVRol.CurrentRow.Cells("s_descripcioncorta").Value)
    ...
    Private Sub BTNEliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNEliminar.Click
        ...
        If MsgBox("¿Esta seguro de querer eliminar a este rol?. No se podran recuperar los datos", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
            Dim SQLEliminarRol As String = ""
            SQLEliminarRol = "DELETE FROM rol WHERE nid=" & DGVRol.CurrentRow.Cells("nid").Value & ""
            objCGenerica.accederBD(SQLEliminarRol)
            mostrarDGVRol()
            BTNCancelar_Click(sender, e)
            MsgBox("Se ha eliminado el rol", MsgBoxStyle.Information)
        Else
            DGVRol.ClearSelection()
        End If
    ...
    Private Sub DGVRol_CellClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DGVRol.CellClick
    ...
    Private Sub TXTBuscar_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TXTBuscar.TextChanged
        ...
        bsDGVRolFilter.Filter = "s_descripcion like '%" & TXTBuscar.Text & "%' "
