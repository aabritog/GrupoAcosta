...
Public Class RSolicitudProducto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GrupoAcosta.RSolicitudProducto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRSolicitudProducto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RSolicitudProducto = New RSolicitudProducto()
        rpt.Site = Me.Site
        Return rpt
    End Function
